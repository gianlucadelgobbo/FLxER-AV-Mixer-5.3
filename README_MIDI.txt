...
- Run FLxERmidiManager.jar	java -jar FLxERmidiManager.jar
...
- Copy the lines with the functions that you want to use in FLxER in "preferences/midiPref.xml" from the list below and assign the midiID and midiVal (minVal,MaxVal OR 0) values from FLxERmidiManager.jar trace:
